...
import com.pineteree.meiriyijian.collect.CollectActivity;
...
public class MeFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        initData();
        //创建适配器
        MeAdapter meAdapter = new MeAdapter(mContex, mList);
        mRecyclerViewVideos.setLayoutManager(new GridLayoutManager(mContex, 2, GridLayoutManager.VERTICAL, false));
    ...
    private void initListener() {
        ...
        mLSettingItemSave.setmOnLSettingItemClick(new LSettingItem.OnLSettingItemClick() {
            @Override
            public void click(boolean isChecked) {
                startActivity(new Intent(mContex, CollectActivity.class));
            }
        });
    }
